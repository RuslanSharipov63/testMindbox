...
import { handleChangeInput, addToDo, clearInput, handleChangeHelperText, focusChange } from "../../store/ChangeInputSlice";
        ...
        <div className="row">
            <div className="input-field col s4">
                ...
                <label
                    className="active"
                    htmlFor="first_name2">
                    {helperText.change === true ? 'некорректная задача' : 'введите задачу'}
                </label>
            </div>
        </div>
    );
